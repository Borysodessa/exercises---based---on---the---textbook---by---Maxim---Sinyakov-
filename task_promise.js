...
Создайте функцию, которая принимает две функции(resolve и reject) и возвращает Promise, который разрешается, если resolve вызывается,
    и отклоняется, если reject вызывается.
